...
from nova_mcp_server.tools import browser_session, list_browser_sessions, inspect_browser
...
async def test_start_and_end_single_session():
    ...
    end_res = await browser_session(action="end", session_id=session_id)
...
async def test_operations_on_invalid_session():
    ...
    exec_res = await browser_session(action="execute", session_id=invalid_sid, instruction="test")
    ...
    end_res = await browser_session(action="end", session_id=invalid_sid)
